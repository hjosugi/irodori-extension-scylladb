//! Native connector ABI for ScyllaDB.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"scylladb","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"scylladb","abiVersion":1,"driverLinked":false,"manifest":"#,
